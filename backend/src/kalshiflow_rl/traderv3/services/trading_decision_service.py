...
class TradingDecisionService:
    ...
    # NOTE: evaluate_whale_queue() was removed on 2024-12-28.
    # Whale queue processing is now handled by WhaleExecutionService via event-driven architecture.
    # See: services/whale_execution_service.py
